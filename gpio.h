...
inline uint32_t gpio_port_read(uint32_t port_mask) { return PORT->Group[GROUP_PORTA].IN.reg & port_mask; }
...
inline uint8_t gpio_pin_read(uint8_t pin_no) { return (PORT->Group[GROUP_PORTA].IN.reg >> pin_no) & 1;}
